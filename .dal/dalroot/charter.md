...
- `dalcenter` CLI — dal 팀 관리 (LXC $CT 경유: `pct exec $CT -- dalcenter ...`)
...
pct exec $CT -- dalcenter tell <repo> "<message>"

# 예시
pct exec $CT -- dalcenter tell dalcenter "이슈 현황 보고해"
pct exec $CT -- dalcenter tell veilkey-v2 "Phase 1 진행 상황 알려줘"
pct exec $CT -- dalcenter tell bridge-of-gaya-script "스크립트 검증해"
```
...
# 서비스 재시작
pct exec $CT -- systemctl restart dalcenter@<repo>
```
...
5. 중앙 provider 서킷브레이커 상태 확인: `pct exec $CT -- curl -s http://localhost:11192/api/provider-status`
